 ...
 */
 ...
 export class VehicleViewPage {
 	...
 	confirm(){
 		...
 		//this.remove();
 		this.car = {brand:this.brand, model: this.model, capacity:this.capacity, colour:this.colour, license:this.license};
 		this.cars.push(this.car);
 		this.storage.remove('car');
 		console.log(this.cars);
 		this.storage.set('car', this.cars).then(data => console.log(data)).catch(err => console.log(err));
 	...
 	edit(){
 		this.navCtrl.setRoot(VehicleViewPage,{vehicle:this.car, read:false});
 	}
